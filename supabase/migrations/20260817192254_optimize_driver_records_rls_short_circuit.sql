...
as $$
begin
  -- Perfis globais precisam sair antes de qualquer busca por motorista.
  -- Isso evita executar subconsultas de prefatura/PNR/risco para cada linha
  -- de driver_records e elimina o statement timeout na sincronização.
