alter table public.profiles
  add column if not exists xpt_scope text[] not null default '{}'::text[];

comment on column public.profiles.xpt_scope is 'Independent XPT responsibility scope for scoped operational users. XPT remains separate from SVC/base scope.';
