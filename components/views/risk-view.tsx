...
export function RiskView() {
  ...
  // O Risco LM é importado como snapshot recorrente. Mantemos o histórico no banco,
  // mas para a visão operacional cada ID usa sempre o lote mais recente.
  ...
  return (
    <div className="view-stack">
      <PageIntro description="A exposição considera um registro por ID de pacote. Em uploads recorrentes, motivo, substatus, dias e GMV exibidos vêm sempre do lote mais recente." chips={[`${formatNumber(scoped.risk.length - rows.length)} repetições consolidadas`, `${reasonData.length} motivos principais`]} />
