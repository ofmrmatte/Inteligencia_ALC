...
export function PrefaturaView() {
  ...
  return (
    <div className="view-stack">
      <PageIntro description="SVC, XPT e PNR permanecem identificados por aba. O valor consolidado usa uma ocorrência por ID de pacote." chips={[`${formatNumber(scoped.prefatura.length)} linhas brutas`, `${formatNumber(uniqueRows.length)} IDs únicos`]} />
