...
export const NAVIGATION: NavigationItem[] = [
  ...
  { id: "bandeja-pnr", label: "Bandeja PNR", shortLabel: "Bandeja PNR", href: "/bandeja-pnr", icon: Inbox, group: "Análises", parentId: "gestao-pnr" },
...
export const SECTION_META: Record<SectionId, { title: string; eyebrow: string; description: string }> = {
  ...
  "bandeja-pnr": { title: "Bandeja PNR", eyebrow: "Integração Case Center", description: "Importe diretamente os casos da Bandeja de suporte do Mercado Livre." },
